 ...
 *
 *  <p>
 *  Gra rozpoczyna siê od potasowania talii kart i po³o¿enia jej grzbietem do góry.
 *  Ka¿dy gracz bierze kartê z góry talii. Gracz, który wyci¹gnie wy¿sz¹ kartê
 ...
 *  Nastêpnie gracz odrzuca jedn¹ kartê na stos kart odrzuconych i pobiera jedn¹ kartê
 *  z góry talii. Je¿eli gracz zbierze karetê, rzuca wszystkie swoje karty na stó³
...
public class FourOfAKind
{
   ...
   public static void main(String[] args)
   {
      ...
      while (true)
      {
         ...
         deck.putBack(hCard);
         deck.putBack(cCard);
         deck.shuffle(); // zapobie¿enie sytuacji, w której ka¿da nastêpna
      ...
      while (true)
      {
         if (curPlayer == HUMAN)
         {
            ...
            {
               choice = prompt("Której karty chcesz siê pozbyæ (A, B, " +
                               "C, D)? ");
               switch (choice)
               {
    ...
    *
    *  @param cards tabilca obiektów <code>Card</code> przekazana do metody
    *
    ...
    *  która jest kart¹ najmniej po¿¹dan¹ do dalszego przetrzymywania.
    *
   ...
   /**
    *  Proœba do gracza, aby wpisa³ znak.
    *
    *  @param msg komunikat prezentowany graczowi
    *
    *  @return wartosæ ca³kowitoliczbowa znaku wpisanego przez gracza.
    */
