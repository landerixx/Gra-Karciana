...
public class DiscardPile
{
   ...
   private int top;
   /**
    *  Tworzy stos kart <code>DiscardPile</code>, w którym mog¹ siê znajdowaæ maksymalnie
    *  52 karty <code>Card</code>. Stos <code>DiscardPile</code> jest na pocz¹tku pusty.
    */
   public DiscardPile()
   {
   ...
   /**
    *  Zwraca kartê <code>Card</code> na górê stosu <code>DiscardPile</code>.
    *
    ...
    *
    *  @return karta <code>Card</code> z góry stosu lub null jeœli stos
