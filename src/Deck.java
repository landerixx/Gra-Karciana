...
public class Deck
{
    ...
    *
    *  @return obiekt karty <code>Card</code> znajduj¹cej siê 
    *  na górze talii <code>Deck</code>
    */
   public Card deal()
   {
    ...
    *
    *  @return true jeœli talia <code>Deck</code> nie zawiera ¿adnej karty <code>Card</code>;
